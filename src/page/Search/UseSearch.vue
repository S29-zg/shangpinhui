...
export default defineComponent({
    ...
    methods: {
        getData() {
            this.$store.dispatch('search/searchShopByLevel1', this.searchParams)
        },
        removeCate() {
                                ...
                                <div class="list-wrap">
                                    <div class="p-img">
                                        <a href="item.html" target="_blank">
                                            <img :src="good.defaultImg" title="大爷来玩啊"/>
                                        </a>
                                    </div>
                                    <div class="price">
                                        <strong>
                                    ...
                                    <div class="attr">
                                        <a target="_blank" href="item.html"
                                           title="促销信息，下单即赠送三个月CIBN视频会员卡！【小米电视新品4A 58 火爆预约中】">Apple苹果iPhone
                                            6s (A1699)Apple苹果iPhone 6s (A1699)Apple苹果iPhone 6s (A1699)Apple苹果iPhone
                                            6s (A1699)</a>
                                    </div>
                                    <div class="commit">
